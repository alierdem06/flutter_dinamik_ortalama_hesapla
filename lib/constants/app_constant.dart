...
class Sabitler {
  ...
  static final TextStyle ortlmGostBodyStyl = GoogleFonts.quicksand(
  ...
  static EdgeInsets yatayPadding8 = const EdgeInsets.symmetric(horizontal: 8);
  static SizedBox sized5Height = const SizedBox(
    height: 5,
  );
}
